...
export const HOUSES = {
  gryffindor: {
    ...
    accent: '#eeba30',
    accent2: '#ffd700',
    // Rich maroon-to-deep-burgundy with warm ember undertones
    bg:  '#1a0000',
    bg2: '#240500',
    bg3: '#300a00',
    bg4: '#3d1200',
    border:  '#6b1a00',
    border2: '#a02800',
    glow:       'rgba(174,0,1,0.35)',
    glowAccent: 'rgba(238,186,48,0.25)',
    textPrimary:   '#ffe8c0',
    textSecondary: '#d4956a',
    textDim:       '#8a4020',
    gradient: 'linear-gradient(135deg, #7a0000 0%, #ae0001 45%, #eeba30 100%)',
    gradientBg: `
      radial-gradient(ellipse at 0% 0%,   rgba(174,0,1,0.55)    0%, transparent 50%),
      radial-gradient(ellipse at 100% 0%, rgba(238,186,48,0.35) 0%, transparent 45%),
      radial-gradient(ellipse at 50% 100%,rgba(120,0,0,0.4)     0%, transparent 55%),
      radial-gradient(ellipse at 50% 50%, rgba(60,10,0,1)        0%, transparent 100%)
    `,
  ...
  slytherin: {
    ...
    accent:    '#c0c0c0',
    accent2:   '#e0e0e0',
    // Deep dungeon green — like the Slytherin common room under the lake
    bg:  '#000f08',
    bg2: '#001a0e',
    bg3: '#002818',
    bg4: '#003820',
    border:  '#005530',
    border2: '#008048',
    glow:       'rgba(26,122,64,0.35)',
    glowAccent: 'rgba(192,192,192,0.2)',
    textPrimary:   '#c0f0d0',
    textSecondary: '#60b880',
    textDim:       '#2a6040',
    gradient: 'linear-gradient(135deg, #003820 0%, #1a7a40 50%, #c0c0c0 100%)',
    gradientBg: `
      radial-gradient(ellipse at 0% 100%,  rgba(26,122,64,0.6)   0%, transparent 50%),
      radial-gradient(ellipse at 100% 0%,  rgba(192,192,192,0.2) 0%, transparent 45%),
      radial-gradient(ellipse at 50% 50%,  rgba(0,30,15,1)        0%, transparent 100%),
      radial-gradient(ellipse at 80% 80%,  rgba(0,80,40,0.3)     0%, transparent 40%)
    `,
  ...
  ravenclaw: {
    ...
    accent:    '#b8860b',
    accent2:   '#daa520',
    // Midnight blue like the Ravenclaw tower at night — deep navy with bronze stars
    bg:  '#00020f',
    bg2: '#00051a',
    bg3: '#000a2a',
    bg4: '#001040',
    border:  '#001870',
    border2: '#0028a0',
    glow:       'rgba(26,58,154,0.4)',
    glowAccent: 'rgba(184,134,11,0.25)',
    textPrimary:   '#c0d0ff',
    textSecondary: '#6080d0',
    textDim:       '#203880',
    gradient: 'linear-gradient(135deg, #0a1060 0%, #1a3a9a 50%, #b8860b 100%)',
    gradientBg: `
      radial-gradient(ellipse at 50% 0%,   rgba(26,58,154,0.7)  0%, transparent 55%),
      radial-gradient(ellipse at 100% 100%,rgba(184,134,11,0.3) 0%, transparent 45%),
      radial-gradient(ellipse at 0% 100%,  rgba(10,16,96,0.5)   0%, transparent 50%),
      radial-gradient(ellipse at 50% 50%,  rgba(0,2,20,1)        0%, transparent 100%)
    `,
  ...
  hufflepuff: {
    ...
    accent:    '#2a2a2a',
    accent2:   '#f5d060',
    // Warm earthy amber — like sunlight through autumn leaves
    bg:  '#0f0a00',
    bg2: '#1a1000',
    bg3: '#261800',
    bg4: '#342200',
    border:  '#5a3c00',
    border2: '#8a5c00',
    glow:       'rgba(212,160,0,0.35)',
    glowAccent: 'rgba(240,192,0,0.3)',
    textPrimary:   '#fff0b0',
    textSecondary: '#d4a030',
    textDim:       '#806020',
    gradient: 'linear-gradient(135deg, #8a5c00 0%, #d4a000 50%, #f0c000 100%)',
    gradientBg: `
      radial-gradient(ellipse at 100% 0%,  rgba(240,192,0,0.45)  0%, transparent 50%),
      radial-gradient(ellipse at 0% 100%,  rgba(212,160,0,0.35)  0%, transparent 50%),
      radial-gradient(ellipse at 50% 50%,  rgba(26,16,0,1)        0%, transparent 100%),
      radial-gradient(ellipse at 50% 0%,   rgba(180,120,0,0.25)  0%, transparent 40%)
    `,
