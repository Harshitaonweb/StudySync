...
export const HOUSES = {
  gryffindor: {
    ...
    textPrimary: '#fff5e0', textSecondary: '#ffb870', textDim: '#cc7040',
  ...
  slytherin: {
    ...
    textPrimary: '#e0fff0', textSecondary: '#80d8a0', textDim: '#50a870',
  ...
  ravenclaw: {
    ...
    textPrimary: '#e8f0ff', textSecondary: '#90b0f0', textDim: '#5878c0',
  ...
  hufflepuff: {
    ...
    textPrimary: '#fff8d0', textSecondary: '#ffc840', textDim: '#c89020',
